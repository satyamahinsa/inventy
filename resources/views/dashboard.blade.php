    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 pl-72 overflow-y-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="text-gray-900 font-medium">Tom Cook</span>
                    </div>
                </div>
            </div>
            <!-- Dashboard Summary -->
            ...
            <div class="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <p class="text-sm text-gray-600 mb-6">The progress and outcomes of Performance Improvement Plans implemented over the last 24 months</p>
                ...
                <!-- Graph Content -->
                <div class="h-32 mt-4 bg-gray-100 rounded-lg"></div>
            </div>
            <!-- Top Penjualan Produk -->
            <div class="grid grid-cols-2 gap-6">
                <div class="bg-white p-6 rounded-lg shadow">
                    <h3 class="text-xl font-semibold mb-4">Top Penjualan Produk</h3>
                    <div class="h-40 w-40 mx-auto bg-gray-200 rounded-full flex items-center justify-center">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="w-24 h-3 bg-yellow-300 rounded-full"></div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="w-16 h-3 bg-green-300 rounded-full"></div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="w-20 h-3 bg-blue-300 rounded-full"></div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="w-18 h-3 bg-pink-300 rounded-full"></div>
