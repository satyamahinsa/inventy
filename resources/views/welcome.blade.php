...
<body class="bg-gray-100">
    ...
    <header class="bg-gradient-to-r from-yellow-400 to-orange-500 p-10 text-white text-center">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="space-x-4">
                <button class="bg-red-600 text-white px-4 py-2 rounded-full font-semibold">
                    <a href="{{ route('dashboard') }}">Log In</a>
                </button>
                <button class="bg-red-600 text-white px-4 py-2 rounded-full font-semibold">Sign Up</button>
            </div>
        </div>
