                ...
                <div class="relative lg:row-start-1 w-full">
                    ...
                    <div class="mt-5 mb-5 relative flex flex-col justify-between h-auto overflow-hidden rounded-tl-[2rem] rounded-bl-[2rem] rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3 flex-1">
                            ...
                            <input type="text" value="{{ $transaction->id }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3 flex-1">
                            <label class="text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">Tanggal Pembelian</label>
                            <input type="date" value="{{ $transaction->created_at->format('Y-m-d') }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3 flex-1">
                            <label class="text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">Nama Lengkap</label>
                            <input type="text" value="{{ $transaction->user->name }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3 flex-1">
                            <label class="text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">Alamat Email</label>
                            <input type="email" value="{{ $transaction->user->email }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                    </div>
                ...
                <div class="relative lg:row-start-2 w-full">
                    ...
                    <div class="mt-3 mb-5 relative flex flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3">
                            ...
                            <input type="text" value="{{ ucfirst($transaction->status) }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3">
                            <label class="text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">Alamat Tujuan</label>
                            <textarea rows="8" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>{{ $transaction->destination_address }}</textarea>
                        </div>
                    </div>
                ...
                <div class="relative lg:row-start-1 lg:col-start-2 lg:col-span-2 w-full">
                    ...
                    <div class="mt-3 mb-5 relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3">
                            ...
                            <input type="text" value="{{ $transaction->shipping_service }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3">
                            <label class="block mt-2 text-lg/7 font-medium tracking-tight text-gray-950 max-lg:text-center">Lacak Pengiriman</label>
                            <div id="map" class="mt-4 mx-5 h-52"></div>
                        </div>
                    </div>
                ...
                <div class="relative lg:row-start-2 lg:col-start-2 lg:col-span-2 w-full">
                    ...
                    <div class="mt-3 mb-5 relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)]">
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3">
                            ...
                            <input type="text" value="Rp {{ number_format($transaction->total_price) }}" class="block mt-2 w-full text-sm/6 text-gray-600 max-lg:text-center border rounded px-3 py-2 bg-gray-200" readonly>
                        </div>
                        <div class="px-4 pt-3 sm:px-5 sm:pt-3">
